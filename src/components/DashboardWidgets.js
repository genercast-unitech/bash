         ...
         <div>
            <!-- Removed Title for cleaner look as per new screenshot -->
             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1.5">
                ...
                <button onclick="window.navigateToModule('checklist')" class="mobile-card-btn bg-white rounded-xl p-3 shadow-sm hover:shadow-lg transition-all border border-gray-100 hover:border-unitech-primary group text-left flex items-center gap-3 h-20 md:h-28 relative overflow-hidden active:scale-95">
                    
                    <div class="relative z-10 flex-shrink-0">
                        <div class="w-12 h-12 md:w-16 md:h-16 bg-slate-900 text-white rounded-lg flex items-center justify-center shadow-lg group-hover:bg-unitech-primary transition-colors">
                            <i data-feather="clipboard" class="w-6 h-6 md:w-8 md:h-8"></i>
                        </div>
                    </div>
                ...
                <button onclick="window.navigateToModule('sales')" class="mobile-card-btn bg-white rounded-xl p-3 shadow-sm hover:shadow-lg transition-all border border-gray-100 hover:border-unitech-primary group text-left flex items-center gap-3 h-20 md:h-28 relative overflow-hidden active:scale-95">
                    
                    <div class="relative z-10 flex-shrink-0">
                        <div class="w-12 h-12 md:w-16 md:h-16 bg-slate-900 text-white rounded-lg flex items-center justify-center shadow-lg group-hover:bg-purple-600 transition-colors">
                            <i data-feather="shopping-cart" class="w-6 h-6 md:w-8 md:h-8"></i>
                        </div>
                    </div>
                ...
                <button onclick="window.navigateToModule('storefront')" class="mobile-card-btn bg-white rounded-xl p-3 shadow-sm hover:shadow-lg transition-all border border-gray-100 hover:border-unitech-primary group text-left flex items-center gap-3 h-20 md:h-28 relative overflow-hidden active:scale-95">
                    
                    <div class="relative z-10 flex-shrink-0">
                        <div class="w-12 h-12 md:w-16 md:h-16 bg-slate-900 text-white rounded-lg flex items-center justify-center shadow-lg group-hover:bg-orange-600 transition-colors">
                            <i data-feather="shopping-bag" class="w-6 h-6 md:w-8 md:h-8"></i>
                        </div>
                    </div>
                ...
                <button onclick="window.navigateToModule('financial')" class="mobile-card-btn bg-white rounded-xl p-3 shadow-sm hover:shadow-lg transition-all border border-gray-100 hover:border-unitech-primary group text-left flex items-center gap-3 h-20 md:h-28 relative overflow-hidden active:scale-95">
                    
                    <div class="relative z-10 flex-shrink-0">
                        <div class="w-12 h-12 md:w-16 md:h-16 bg-slate-900 text-white rounded-lg flex items-center justify-center shadow-lg group-hover:bg-emerald-600 transition-colors">
