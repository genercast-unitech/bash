...
// --- Tenant Schema (SaaS Mastery) ---
export const TenantSchema = z.object({
    id: z.string(),
    name: z.string().min(2),
    subdomain: z.string().optional(),
    status: z.enum(['active', 'suspended', 'trial', 'canceled']).default('trial'),
    plan: z.enum(['basic', 'pro', 'enterprise', 'master']).default('trial'),
    ...
    storageLimitGB: z.number().default(5),
    currentUsageBytes: z.number().default(0),
    billingDay: z.number().min(1).max(31).default(10),
    // Dynamic Feature Flags
    enabledFeatures: z.array(z.string()).default(['dashboard', 'sales', 'clients', 'storefront']),
...
// --- SaaS Global Settings (Gateways, etc) ---
export const SassSettingsSchema = z.object({
    id: z.string().default('global'),
    appName: z.string().default('UniTech'),
