    ...
    async init(containerId, params = {}) {
        ...
        container.innerHTML = `
            <div class="h-full flex flex-col gap-3 animate-fade-in text-white p-2 md:p-4">
                ...
                <!-- Products Table -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 flex-1 overflow-hidden flex flex-col min-h-0 mb-4">
                        ...
                        <table class="w-full text-left border-collapse table-fixed">
                            ...
                            <thead class="bg-slate-900 text-white uppercase text-[8px] md:text-[10px] font-black sticky top-0 z-10 shadow-xl overflow-hidden rounded-t-lg">
                                <tr>
                                    ...
                                    <th class="p-4 border-slate-800 hidden lg:table-cell">CAT.</th>
                                    <th class="p-4 border-slate-800 hidden lg:table-cell">SUPP.</th>
                                    <th class="p-0.5 md:p-4 text-center border-slate-800" title="Estoque"><i data-feather="box" class="w-3 h-3 mx-auto hidden md:block"></i><span class="md:hidden">EST.</span></th>
