...
export const DashboardWidgets = () => {
    ...
    // Filter Persistence
    if (!window.dashboardFinancialFilter) window.dashboardFinancialFilter = 'month';
    ...
    */
    ...
    // 3. Render
    return `
      <div class="space-y-3 animate-fade-in pb-12 pt-2">
         ...
         <!-- Section: Financial Summary -->
          <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mobile-hide">
             ...
             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                 <!-- Receitas -->
                  <div onclick="window.navigateToModule('financial', { situation: 'Pago', type: 'revenue' })" class="p-6 rounded-2xl border border-gray-100 bg-white flex justify-between items-center relative overflow-hidden cursor-pointer hover:border-green-400 hover:shadow-lg transition-all group">
                     <div class="relative z-10">
                         <div class="w-10 h-10 rounded-md bg-green-500 text-white flex items-center justify-center mb-4 shadow-lg shadow-green-500/30">
                             <i data-feather="trending-up" class="w-5 h-5"></i>
                         </div>
                         <p class="text-[10px] text-gray-600 uppercase font-bold tracking-wider">Receitas Recebidas</p>
                         <p class="text-2xl font-bold text-green-500">R$ ${revenueTotal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                     </div>
                     <div class="w-24 h-24 bg-green-50 rounded-full absolute -right-6 -top-6"></div>
                 </div>

                  <!-- Despesas -->
                  <div onclick="window.navigateToModule('financial', { situation: 'Pago', type: 'expense' })" class="p-6 rounded-2xl border border-gray-100 bg-white flex justify-between items-center relative overflow-hidden cursor-pointer hover:border-red-400 hover:shadow-lg transition-all group">
                     <div class="relative z-10">
                         <div class="w-10 h-10 rounded-md bg-red-500 text-white flex items-center justify-center mb-4 shadow-lg shadow-red-500/30">
                             <i data-feather="trending-down" class="w-5 h-5"></i>
                         </div>
                         <p class="text-[10px] text-gray-600 uppercase font-bold tracking-wider">Despesas Pagas</p>
                         <p class="text-2xl font-bold text-red-500">R$ ${expenseTotal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                     </div>
                     <div class="w-24 h-24 bg-red-50 rounded-full absolute -right-6 -top-6"></div>
                 </div>

                  <!-- A Receber -->
                  <div onclick="window.navigateToModule('financial', { situation: 'Pendente', type: 'revenue' })" class="p-6 rounded-2xl border border-gray-100 bg-white flex justify-between items-center relative overflow-hidden cursor-pointer hover:border-blue-400 hover:shadow-lg transition-all group">
                     <div class="relative z-10">
                         <div class="w-10 h-10 rounded-md bg-blue-500 text-white flex items-center justify-center mb-4 shadow-lg shadow-blue-500/30">
                             <i data-feather="clock" class="w-5 h-5"></i>
                         </div>
                         <p class="text-[10px] text-gray-600 uppercase font-bold tracking-wider">A Receber</p>
                         <p class="text-2xl font-bold text-blue-500">R$ ${receivables.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                     </div>
                     <div class="w-24 h-24 bg-blue-50 rounded-full absolute -right-6 -top-6"></div>
                 </div>

                  <!-- A Pagar -->
                  <div onclick="window.navigateToModule('financial', { situation: 'Pendente', type: 'expense' })" class="p-6 rounded-2xl border border-gray-100 bg-white flex justify-between items-center relative overflow-hidden cursor-pointer hover:border-orange-400 hover:shadow-lg transition-all group">
                     <div class="relative z-10">
                         <div class="w-10 h-10 rounded-md bg-orange-500 text-white flex items-center justify-center mb-4 shadow-lg shadow-orange-500/30">
                             <i data-feather="hourglass" class="w-5 h-5"></i>
                         </div>
                         <p class="text-[10px] text-gray-600 uppercase font-bold tracking-wider">A Pagar</p>
                         <p class="text-2xl font-bold text-orange-500">R$ ${payables.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                     </div>
                     <div class="w-24 h-24 bg-orange-50 rounded-full absolute -right-6 -top-6"></div>
                 </div>
             </div>
          </div>
