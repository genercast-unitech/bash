...
export class LoginModule {
    async init(containerId) {
        ...
        // Auto-Seed Master User if missing (Hotfix)
        try {
            const users = storage.getUsers();
            if (!users.find(u => u.email === 'gener-cell@hotmail.com')) {
                console.log('Auto-seeding Master User: Gener Cell');
                storage.addUser({
                    id: 1000,
                    tenantId: 'master',
                    name: 'Gener Cell',
                    ...
                    password: 'Sophia2021@',
                    role: 'master',
                    avatar: 'https://ui-avatars.com/api/?name=Gener+Cell&background=000&color=fff'
                });
            }
