...
export class SalesModule {
    ...
    render() {
        ...
        <div class="flex flex-col h-full gap-4 animate-fade-in">
            <!-- Header Toolbar -->
            <div class="flex justify-between items-center bg-[#fff2e6] dark:bg-transparent border border-orange-100 dark:border-transparent p-4 rounded-lg shadow-sm dark:shadow-none transition-colors">
                <div class="flex items-center gap-4 flex-1">
                    ...
                    <select id="pos-category" class="p-2.5 bg-gray-50 dark:bg-slate-900/50 border border-gray-300 dark:border-slate-800 rounded-lg focus:ring-2 focus:ring-unitech-primary outline-none text-sm text-gray-700 dark:text-gray-200 hidden md:block">
                ...
                <div class="flex items-center gap-3">
                    <div class="flex bg-gray-100 dark:bg-slate-800 p-1 rounded-lg">
                        <button class="px-3 py-1.5 rounded-md text-xs font-bold transition-colors ${this.pricingMode === 'retail' ? 'bg-white text-unitech-primary shadow-sm dark:bg-slate-700 dark:text-white dark:shadow-none' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}" id="mode-retail">VAREJO</button>
                        <button class="px-3 py-1.5 rounded-md text-xs font-bold transition-colors ${this.pricingMode === 'wholesale' ? 'bg-white text-unitech-primary shadow-sm dark:bg-slate-700 dark:text-white dark:shadow-none' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}" id="mode-wholesale">ATACADO</button>
                    </div>
                    
                    <button id="btn-history" class="p-2.5 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg transition-colors" title="Histórico de Vendas">
    ...
    renderIdleScreen() {
        ...
        return `
        <div class="col-span-full h-full min-h-[450px] flex flex-col items-center justify-center p-8 bg-[#fff2e6] dark:bg-slate-950 rounded-[2.5rem] border border-orange-100/50 dark:border-slate-800 shadow-[xl_inset] animate-fade-in relative overflow-hidden group">
            ...
            <div class="z-10 relative mb-10 text-center">
                <div class="relative bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl px-16 py-10 rounded-[3.5rem] border border-white dark:border-slate-800 shadow-[0_20px_60px_rgba(238,68,68,0.08)] dark:shadow-none transition-all">
                    <h1 class="text-7xl md:text-8xl font-black leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-gray-900 to-gray-600 dark:from-white dark:to-slate-400 mb-2">
                        CAIXA
                    </h1>
            ...
            <div class="z-10 flex flex-col items-center gap-4">
                <div class="relative flex flex-col items-center">
                    <span id="idle-clock" class="text-7xl md:text-[6rem] font-black text-[#1a1a1a] dark:text-white dark:drop-shadow-[0_0_25px_rgba(255,255,255,0.25)] tracking-tight tabular-nums drop-shadow-sm leading-none transition-all duration-300">
                        ${currentTime}
                    </span>
