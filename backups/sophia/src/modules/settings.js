...
export class SettingsModule {
    constructor() {
        ...
        this.currentTab = 'company'; // company, backup, theme
    }
            ...
            case 'backup':
                return `
                    <div class="space-y-8 animate-fade-in">
                        ...
                        <!-- Financial Reset -->
                        <div>
                            <h3 class="text-sm font-bold text-gray-800 mb-4 border-b pb-2">Reiniciar Financeiro</h3>
                            <div class="p-4 border border-orange-200 rounded-lg bg-orange-50">
                                <p class="text-sm text-orange-700 mb-3">
                                    <b>Zerar Movimentação:</b> Isso apagará todas as <b>Vendas</b> e <b>Transações Financeiras</b>. O saldo do caixa voltará a zero. Clientes e Estoque não serão afetados.
                                </p>
                                <button id="reset-financial-btn" class="px-4 py-2 bg-orange-600 text-white rounded-md hover:bg-orange-700 text-sm font-bold flex items-center gap-2 transition-all">
                                    <i data-feather="refresh-ccw" class="w-4 h-4"></i> ZERAR HISTÓRICO FINANCEIRO
                                </button>
                            </div>
                        </div>
                        ...
                        <!-- Restore -->
                        <div>
                            <h3 class="text-sm font-bold text-gray-800 mb-4 border-b pb-2">Zona de Perigo: Restauração de Dados</h3>
                            <div class="p-4 border border-red-200 rounded-lg bg-red-50">
                                <p class="text-sm text-red-700 mb-3">
                                    <b>Atenção:</b> Importar um arquivo de backup irá <u>sobrescrever</u> todos os dados atuais do sistema. Esta ação não pode ser desfeita.
                                </p>
                                <div class="flex items-center gap-4">
                                    <input type="file" id="restore-file" accept=".json" class="hidden" />
                                    <label for="restore-file" class="cursor-pointer btn-secondary text-red-600 border-red-200 hover:bg-red-100 flex items-center gap-2">
                                        <i data-feather="upload-cloud" class="w-4 h-4"></i> Carregar Arquivo de Backup
                                    </label>
                                    <span id="restore-filename" class="text-xs text-gray-500">Nenhum arquivo selecionado</span>
                                </div>
                                <div id="restore-actions" class="hidden mt-4 pt-4 border-t border-red-200">
                                     <button id="confirm-restore-btn" class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 text-sm font-bold w-full">
